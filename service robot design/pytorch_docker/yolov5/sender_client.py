...
PyTorch_REST_API_URL = 'http://algm-223873876891680768.competition.harix.iamidata.com/xuni/inference'
...
def predict_result(image_path):
    ...
    payload = {'image': cv2_base64(image)}
...
for i in range(1):
    predict_result('data/images/0412.jpg')
